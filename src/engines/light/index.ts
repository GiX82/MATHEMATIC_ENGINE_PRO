...
const lightEngines: ILightEngine[] = [
  {
    ...
    params: [],
    lights: [
      { type: 'ambient', color: '#e8e0f0', intensity: 0.4 },
      { type: 'directional', color: '#8ae6ff', intensity: 0.9, position: [5, 4, 6] },
      { type: 'directional', color: '#ff7bd5', intensity: 0.5, position: [-5, -2, 4] },
    ],
  },
  {
    ...
    lights: [
      ...
      { type: 'directional', color: '#ffd700', intensity: 1.0, position: [3, 8, 5] },
      { type: 'directional', color: '#4a0080', intensity: 0.6, position: [-4, -3, 6] },
      { type: 'point', color: '#00ffff', intensity: 0.6, position: [0, 0, 4] },
    ],
  },
  {
    ...
    lights: [
      ...
      { type: 'point', color: '#ff00ff', intensity: 1.2, position: [3, 2, 3] },
      { type: 'point', color: '#00ffff', intensity: 1.2, position: [-3, -2, 3] },
      { type: 'point', color: '#ffff00', intensity: 0.8, position: [0, 4, -2] },
    ],
  },
  {
    ...
    params: [],
    lights: [
      { type: 'ambient', color: '#f5f5f5', intensity: 0.4 },
      { type: 'directional', color: '#ffffff', intensity: 1.0, position: [4, 6, 4] },
      { type: 'directional', color: '#b0c4de', intensity: 0.5, position: [-3, 2, 5] },
      { type: 'directional', color: '#ffe4b5', intensity: 0.3, position: [0, -2, 6] },
    ],
  },
  {
